USE [unscproduzione]
GO
/****** Object:  StoredProcedure [dbo].[SP_INVIO_MAIL_ASSGARANZIAGIOVANI]    Script Date: 14/10/2025 12:36:28 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[SP_INVIO_MAIL_ASSGARANZIAGIOVANI]
...
EXEC @RC = dbo.SSIS_sp_send_dbmail
	@profile_name = 'ASSGARANZIAGIOVANI',
