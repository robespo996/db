USE [unscproduzione]
GO
/****** Object:  StoredProcedure [dbo].[SP_INVIO_MAIL_STARTUP_SECONDO_ALERT]    Script Date: 14/10/2025 12:36:28 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
-- Procedura Invio Mail relativo al giorno 10 del mese successivo alla data di inizio servizio
ALTER PROCEDURE [dbo].[SP_INVIO_MAIL_STARTUP_SECONDO_ALERT]
AS
	DECLARE
	...
	BEGIN
		...
		AND	Entit‡.datainizioservizio < CONVERT(date,'2024-06-01')
