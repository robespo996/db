USE [unscproduzione]
GO
/****** Object:  StoredProcedure [dbo].[SP_INVIO_MAIL_ELEZIONI_TEXT]    Script Date: 14/10/2025 12:36:28 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO

ALTER PROCEDURE [dbo].[SP_INVIO_MAIL_ELEZIONI_TEXT]
	@MAILINVIATORE VARCHAR(100), 
	@NOMEINVIATORE VARCHAR(100),
	@MAILDESTINATARIO VARCHAR(500), 
