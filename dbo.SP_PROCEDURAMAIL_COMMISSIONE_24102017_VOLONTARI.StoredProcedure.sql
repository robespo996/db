USE [unscproduzione]
GO
/****** Object:  StoredProcedure [dbo].[SP_PROCEDURAMAIL_COMMISSIONE_24102017_VOLONTARI]    Script Date: 14/10/2025 12:36:29 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[SP_PROCEDURAMAIL_COMMISSIONE_24102017_VOLONTARI]
--@gruppo as int
AS
DECLARE
            @OGGETTO          VARCHAR(500),
...
<br/>Commissione Elettorale</p>'
      ...
      DECLARE MYCUR CURSOR LOCAL FOR
            select CodiceVolontario,EMAIL from [unscproduzione].[dbo].[_Mail_Commissione_24102017_Volontari]
      OPEN MYCUR
