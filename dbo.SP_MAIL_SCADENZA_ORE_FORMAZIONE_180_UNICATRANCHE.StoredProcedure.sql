USE [unscproduzione]
GO
/****** Object:  StoredProcedure [dbo].[SP_MAIL_SCADENZA_ORE_FORMAZIONE_180_UNICATRANCHE]    Script Date: 14/10/2025 12:36:28 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[SP_MAIL_SCADENZA_ORE_FORMAZIONE_180_UNICATRANCHE]
...
SET @CONTA = 0
SET @OGGETTO = 'AVVISO SCADENZA ORE DI FORMAZIONE (180 GIORNI UNICA TRANCHE)'
SET @MESSAGGIO = '<FONT face="Verdana" size="4" Color="Red">
		...
		<TABLE CellPadding=3 CellSpacing=3 Border=1 Width="600"><TR><TD><B>Competenza</B></TD><TD><B>Ente</B></TD><TD><B>Progetto</B></TD><TD align="center"><B>Data Inizio Progetto</B></TD><TD align="center"><B>Data Fine Progetto</B></TD><TD align="center"><B>Progetto Sottoposto a Verifica</B></TD><TD align="center"><B>Totale Volontari</B></TD><TD align="center"><B>Volontari in Servizio a 180gg dall''inizio progetto</B></TD><TD align="center"><B>Totale Volontari con ore caricate</B></TD></TR>'
