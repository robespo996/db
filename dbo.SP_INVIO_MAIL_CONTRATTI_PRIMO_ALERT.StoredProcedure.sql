USE [unscproduzione]
GO
/****** Object:  StoredProcedure [dbo].[SP_INVIO_MAIL_CONTRATTI_PRIMO_ALERT]    Script Date: 14/10/2025 12:36:28 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
-- Procedura Invio Mail relativo al giorno 5 del mese
ALTER PROCEDURE [dbo].[SP_INVIO_MAIL_CONTRATTI_PRIMO_ALERT]
AS
	DECLARE
	...
	BEGIN
		...
		AND	convert(date,Entit‡.datainizioservizio)= convert(date,GETDATE()-5)
