USE [unscproduzione]
GO
/****** Object:  StoredProcedure [dbo].[SP_SIGMA_GENERAZIONE_SIMULATORE]    Script Date: 14/10/2025 12:36:30 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[SP_SIGMA_GENERAZIONE_SIMULATORE] 
...
--RAISERROR (@pathSharedFolder, 10, 1) WITH NOWAIT
...
RAISERROR ('SIGMA_SNAPSHOT_VW_MANDATI', 10, 1) WITH NOWAIT
--insert into dbo.[log] (timestamp, idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SIGMA_SNAPSHOT_VW_MANDATI')
...
--	insert into dbo.[log] (timestamp, idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SIGMA_SNAPSHOT_VW_MANDATI_VOLONTARIPAGATI')
...
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SIGMA_SNAPSHOT_VW_REND_MANDATI_VOLONTARIPAGATI')
...
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SIGMA_SNAPSHOT_VW_GG_PAGAMENTI_RIMBORSI')
...
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SIGMA_SNAPSHOT_VW_PAGAMENTI_FORMAZIONE_GG_Progetti')
...
PRINT 'AP00'
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','AP00')
	...
	BEGIN	
		PRINT 'AP02'
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','AP02')
	...
	BEGIN	
		PRINT 'AP03'
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','AP03')
	...
	BEGIN	
		PRINT 'AP06'				
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','AP06')
...
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','FN00')
...
--exec [SP_SIGMA_GENERAZIONE_LOG] @idgenerazione, 'Entering', 'FN02',''
RAISERROR ('', 10, 1) WITH NOWAIT
...
--exec [SP_SIGMA_GENERAZIONE_LOG] @idgenerazione, 'Exiting', 'FN02',@ESITO

	
RAISERROR ('', 10, 1) WITH NOWAIT
--exec [SP_SIGMA_GENERAZIONE_LOG] @idgenerazione, 'Entering', 'FN06',''
...
--exec [SP_SIGMA_GENERAZIONE_LOG] @idgenerazione, 'Exiting', 'FN06',@ESITO

	
	PRINT 'FN08' --SEMPRE, ANCHE PER MANDATO FORMAZIONE
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','FN08')
RAISERROR ('', 10, 1) WITH NOWAIT
	...
	IF @flagformazione = 'NO'
	BEGIN	
RAISERROR ('FO00', 10, 1) WITH NOWAIT
		PRINT 'FO00'
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','FO00')
	...
	IF @flagformazione = 'NO'
	BEGIN	
RAISERROR ('PR00', 10, 1) WITH NOWAIT
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','PR00')
		PRINT 'PR00'
	...
	IF @flagformazione = 'NO'
	BEGIN	
RAISERROR ('PR01', 10, 1) WITH NOWAIT
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','PR01')
		PRINT 'PR01'
	...
	IF @flagformazione = 'NO'
	BEGIN	
RAISERROR ('SC00', 10, 1) WITH NOWAIT
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SC00')
		PRINT 'SC00'
	...
	IF @flagformazione = 'NO'
	BEGIN	
RAISERROR ('SC01', 10, 1) WITH NOWAIT
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SC01')
		PRINT 'SC01'
...
RAISERROR ('SD01', 10, 1) WITH NOWAIT
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SD01')
...
RAISERROR ('SD02', 10, 1) WITH NOWAIT
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SD02')
...
RAISERROR ('SD03', 10, 1) WITH NOWAIT
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SD03')
...
RAISERROR ('SD04', 10, 1) WITH NOWAIT
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SD04')
...
RAISERROR ('SD06', 10, 1) WITH NOWAIT
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE','SD06')
...
--insert into dbo.[log] ([timestamp], idlevel, applicationname, message) values (getdate(), 1, 'SP_SIGMA_GENERAZIONE: Esito',@Esito)

fine:
select * from SIGMA_TABELLA_SD01 where IdGenerazione=@IdGenerazione order by idrecord asc
