USE [unscproduzione]
GO
/****** Object:  StoredProcedure [dbo].[SP_INVIO_MAIL]    Script Date: 14/10/2025 12:36:28 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO

ALTER PROCEDURE [dbo].[SP_INVIO_MAIL]
	@MAILINVIATORE VARCHAR(100), 
	@NOMEINVIATORE VARCHAR(100),
	@MAILDESTINATARIO VARCHAR(8000), 
	@COPIACARBONE VARCHAR(8000),
	@COPIACARBONEB VARCHAR(8000),
	@OGGETTO VARCHAR(200),
