USE [unscproduzione]
GO
/****** Object:  StoredProcedure [dbo].[SP_PROCEDURAMAIL_COMMISSIONE_01032017_VOLONTARI]    Script Date: 14/10/2025 12:36:29 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[SP_PROCEDURAMAIL_COMMISSIONE_01032017_VOLONTARI]
--@gruppo as int
AS
DECLARE
            @OGGETTO          VARCHAR(500),
...
<p>commissioneelettorale@serviziocivile.it</p>'
      ...
      DECLARE MYCUR CURSOR LOCAL FOR
            select codicevolontario,EMAIL from [unscproduzione].[dbo].[_Mail_Commissione_01032017_Volontari]
      OPEN MYCUR
